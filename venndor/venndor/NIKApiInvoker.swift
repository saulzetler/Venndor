...
final class NIKRequestBuilder {
    ...
    /**
     ...
     - Parameter contentType: json or xml
     */
    static func restPath(path: String, method: String, queryParams: [String: AnyObject]?, var body: AnyObject?, headerParams: [String: String]?, contentType: String?) -> NSURLRequest {

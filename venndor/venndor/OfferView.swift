...
class OfferView: UIView {
    ...
    func setupBackButton() {
        ...
        let backButton = makeImageButton("Back_Arrow.png", frame: buttonSize, action: #selector(OfferView.goBack(_:)), tinted: false, circle: false, backgroundColor: 0x000000, backgroundAlpha: 0)
